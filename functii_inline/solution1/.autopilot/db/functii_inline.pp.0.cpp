# 1 "functii_inline/functii_inline.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "functii_inline/functii_inline.cpp" 2
...
__attribute__((sdx_kernel("fi", 0))) void fi(bool a, bool b, bool *c) {
#pragma HLS TOP name=fi
# 9 "functii_inline/functii_inline.cpp"

# 1 "Tema1/intersection_semaphores.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 158 "D:/Xilinx/Vitis_HLS/2021.1/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
extern "C" {
...
# 2 "<built-in>" 2
# 1 "Tema1/intersection_semaphores.cpp" 2
...
__attribute__((sdx_kernel("intersection", 0))) void intersection(bool Stg, bool D, bool S, bool J, int *Regula, bool *EW, bool *NS) {
#pragma HLS TOP name=intersection
# 41 "Tema1/intersection_semaphores.cpp"
